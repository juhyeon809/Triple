...
select * from coupon;
insert into coupon values (1, 1, '[8월 혜택]국내 숙소 할인 3,000원', 'LODGING', 3000, '5만원 이상 예약 시', 'USABLE', 'a111', null, '2022-08-31', 'USABLE');
insert into coupon values (2, 2, '[8월 혜택]투어 할인 3,000원', 'TOUR', 3000, '5만원 이상 예약 시', 'USABLE', 'a333', null, '2022-08-31', 'USABLE');
insert into coupon values (3, 3, '[8월 혜택]항공 할인 3,000원', 'AIR', 3000, '5만원 이상 예약 시', 'USABLE', 'a222', null, '2022-08-31', 'USABLE');
insert into coupon values (4, 4, '[7월 혜택]국내 숙소 할인 3,000원', 'LODGING', 3000, '5만원 이상 예약 시', 'EXPIRED', 'a111', null, '2022-08-31', 'USED');
...
insert into mysave values(1, 3, 111, 'Y', null, '占쏙옙占싱듸옙', '2022-08-01');
insert into mysave values(2, 3, 222, 'Y', null, '占쏙옙占싱듸옙', '2022-08-01');
insert into mysave values(3, 3, 333, 'Y', null, '占쏙옙占쏙옙', '2022-08-01');
insert into mysave values(4, 3, 444, 'Y', null, '占쏙옙占쏙옙', '2022-08-01');
insert into mysave values(5, 3, 555, 'Y', null, '占쏙옙占쏙옙', '2022-08-01');
insert into mysave values(6, 3, 666, 'Y', null, '占쏙옙占쏙옙', '2022-08-01');
insert into mysave values(7, 3, 777, 'Y', null, '占쏙옙占쏙옙', '2022-08-01');
insert into mysave values(8, 3, 888, 'Y', null, '占쏙옙占쏙옙', '2022-08-01');
insert into mysave values(9, 3, 999, 'Y', null, '占쏙옙占쏙옙', '2022-08-01');
insert into mysave values(10, 3, 1010, 'Y', null, '占쏙옙占쏙옙', '2022-08-01');
...
insert into faq values(1, 'SERVICE', 1, '사과', '예약은 어디서 볼 수 있나요?', '회원 탈퇴는 아래의 방법을 통해 가능합니다.

- 이메일 회원

트리플 사이트 메인 > 우측 상단 마이페이지 > 설정 > 서비스 탈퇴 > 비밀번호 입력 > 탈퇴합니다 선택
